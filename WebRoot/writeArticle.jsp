...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="css/writeArticle.css">
  ...
  <main>
    <h1>请在这里编辑你的文章</h1>
     <s:form action="Article_saveArticle" method="POST" cssClass="edit_articles">
	   ...
	   <div class="form-group">
	    ...
	    <s:textarea id="acontent" name="acontent" cssClass="form-control" rows="8"/>
	   </div>
	   <div class="form-group">
	    <input type="button" value="保存" class="btn btn-warning"/>
